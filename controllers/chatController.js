...
module.exports = (io) => {
  ...
  router.post('/messages', auth, async (req, res) => {
    try {
      const { chatId, content, isImage = false, replyTo } = req.body;
      ...
      // Return to sender (for pending → real replacement)
  ...
  // -----------------------------------------------------------------
  // PATCH /api/messages/:id/read – Mark as read (for seen ticks)
  // -----------------------------------------------------------------
